			...
			<div class="col s12 m8 offset-m2 l6 offset-l3">
				<div class="card-panel grey lighten-5 z-depth-1">
					<div class="row valign-wrapper">
						<div class="col s2">
							<img src="assets/user.jpg" alt="" class="circle responsive-img">
							<!-- notice the "circle" class -->
						</div>
						<div class="col s10">
							<span class="black-text">
								<h4>
									Welcome user <a href="?page=Setting"><jsp:getProperty
											name="subuser" property="name" /></a>!
								</h4> <span>等级:<%=subuser.getLevel()%> 积分:<%=subuser.getScore()%>
							</span> <span>余额:<a href="?page=Purchase"
									class="tooltipped mdl-color-text--pink" data-tooltip="充值"><jsp:getProperty
											name="subuser" property="balance" /></a> </span> </span>
						</div>
					</div>
				</div>
			</div>
			<div>
				<p>You are using the world's most excellent IFTTT service!</p>
				<p>IFTTT is a trigger based web service that helps you manage
					your tasks. You can use IFTTT to automate your tasks, such as
					sending mail and posting weibo. However, you cannot use it to reach
					Mars.</p>
