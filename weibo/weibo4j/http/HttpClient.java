...
public class HttpClient implements java.io.Serializable {
	...
	private static final int INTERNAL_SERVER_ERROR = 500;// Internal Server Error: Something is broken.  Please post to the group so the WeiboServlet team can investigate.
	private static final int BAD_GATEWAY           = 502;// Bad Gateway: WeiboServlet is down or being upgraded.
	private static final int SERVICE_UNAVAILABLE   = 503;// Service Unavailable: The WeiboServlet servers are up, but overloaded with requests. Try again later. The search and trend methods use this to indicate when you are being rate limited.
	...
	private static String getCause(int statusCode) {
		...
		case INTERNAL_SERVER_ERROR:
			cause = "Something is broken.  Please post to the group so the WeiboServlet team can investigate.";
			break;
		case BAD_GATEWAY:
			cause = "WeiboServlet is down or being upgraded.";
			break;
		case SERVICE_UNAVAILABLE:
			cause = "Service Unavailable: The WeiboServlet servers are up, but overloaded with requests. Try again later. The search and trend methods use this to indicate when you are being rate limited.";
			break;
		default:
			cause = "";
		}
