	...
	<div class="demo-layout-transparent mdl-layout mdl-js-layout">
		...
		<div class="login">
			<div class="login-form">
				<div class="warning" style="display: none" id="InvalidLogin">Please
				...
				<form action="/login.do" method="POST" id="login">
					...
					<label class=""> <span>Username</span> <input
						type="username" id="u" autofocus="autofocus"
						novalidate="novalidate" spellcheck="false" autocomplete="username"
						name="username"> </label> <label class=""> <span>Password</span>
					...
					<div class="create">
						<span>Don't have an account yet?</span> <a href="/register.jsp">Create
							an account</a>
					</div>
				</form>
			</div>
